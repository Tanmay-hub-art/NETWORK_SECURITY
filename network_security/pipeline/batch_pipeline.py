...
from network_security.entity.artifact_intity import (
...
class TrainingPipeline:
    ...
    def start_data_ingestion(self):
        try:
            ...
            logging.info('Initiate the start data ingestion')
    ...
    def run_pipeline(self):
        try:
            ...
            data_transfromation_artifcat = self.start_data_transformation(data_validation_artifact=data_validation_artifact)
            model_trainer_artifact = self.start_model_trainer(data_transformation_artifact=data_transfromation_artifcat)
            return model_trainer_artifact
        except Exception as e:
            raise NetworkSecurityException(e,sys)
